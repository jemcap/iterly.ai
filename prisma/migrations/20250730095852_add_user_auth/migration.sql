-- AlterTable
ALTER TABLE "design_files" ADD COLUMN     "userId" TEXT;
...
-- AddForeignKey
ALTER TABLE "design_files" ADD CONSTRAINT "design_files_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
